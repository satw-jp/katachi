...
| Redo | A | `main.ts` workflow snapshot/history routing and UI callbacks | Project bar / workflow history controls | `historyUndo.test.ts`, rebuild workflow tests | `9b69688` and current recovery baseline | no | Use existing redo path | None |
