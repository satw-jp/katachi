...
- legacy v088 compatibility semantics; no migration without separate C SOL scope
...
## Evidence boundary
### Proven / supported
- SKIN-native C v0 reproduces the accepted Research M/M-R BODY family.
- Permanent BODY remains unchanged through support wiring and FIELD vNext restoration.
- current Stage8 offset-bend support is exported separately from Artwork BODY.
- FIELD vNext is retained without authoring / BODY / Support / 3MF mutation.
