...
Ten-site [study folder](https://drive.google.com/drive/folders/1JDKcvoTZ55fhHTyh8EYUMG3eR-HV4Afh): selected_v8 is the final locally adopted selection. `audit/ADDITIONAL_TEN_LOCAL_ADOPTION.json` fixes38 parts under `geometry/official_additional_ten`; [all38 cloud files](https://drive.google.com/drive/folders/1ZA2qhEEisin12XlAA_Jr8Ptdck9hsV9c) and sizes are confirmed in `audit/ADDITIONAL_TEN_DRIVE_SAVE_RECEIPT.json`. `validation_v8/FINAL_REMOVAL_GATE.json` ties each complete contact head to an accessible cut and continuous withdrawal, retaining exact unchanged-head evidence. F1394_0 uses a1mm local shaft displacement with zero unexpected Artwork intersection; actual cuts atZ124/127.5/131/137.149 and each fragment withdrawal PASS conditionally. Earlier rejected v7 and failed long-fragment studies never enter input. Actual strength/jaws/scars remain unproven.
