...
| `hikari-blender-backlight-study.hkr` | `World strength=1`相当、有限な背面発光面、IOR 1.45、同IOR・吸収0の滑らかな内包、roughness 0.05 | `study_01_light_size05.blend`の実レンダー条件を再現し、無吸収領域が隣接hostより明るく抜ける関係を見る。太陽や物理的な窓とは呼ばず、床の受光には未接続と明記する。 |
