...
|---|---|---|---|
| Author / decision owner | CORE; relevant CURRENT fronts; relevant task | evidence and dependency pointers | cross-lane CURRENTs; architecture; history |
| LUNA | CORE minimum; lane CURRENT front; bounded task | named code/evidence | STATEMENT; RESEARCH; other lanes; old tasks |
| Research decision owner | CORE; research task/current | relevant research sources; named implementation dependencies | unrelated implementation history |
...
| Viewer decision owner / LUNA | CORE; VIEWER CURRENT front; Viewer task | FKEI/Viewer evidence | HANA/SKIN philosophy; other lanes |
