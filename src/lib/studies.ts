...
export const STUDY_CATALOG: readonly StudyCatalogEntry[] = [
  ...
  {
    id: "flower-packing-spike",
    href: "flower-packing-spike.html",
    titleJa: "花を詰める",
    titleEn: "Flower Packing Spike",
    principle:
      "同じFlower・同じ配置面・同じSeedで、形を保つRigidと押されて応答するSoft、外接球と複数球の当たり判定を比較する。",
    researchOrder: 12,
