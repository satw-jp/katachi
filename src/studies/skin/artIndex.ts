...
visualStudiesLink.href = "/skin-art/studies/";
...
conceptMoviesLink.href = "/skin-art/concepts/";
...
conceptMoviesV2Link.href = "/skin-art/concepts-v2/";
conceptMoviesV2Link.textContent = "CONCEPT MOVIES V2 ↗";
const conceptMoviesV3Link = document.createElement("a");
conceptMoviesV3Link.className = "skin-art-index-studies-link";
conceptMoviesV3Link.href = "/skin-art/concepts-v3/";
conceptMoviesV3Link.textContent = "CONCEPT MOVIES V3 ↗";
const conceptLabV4Link = document.createElement("a");
conceptLabV4Link.className = "skin-art-index-studies-link";
conceptLabV4Link.href = "/skin-art/concepts-v4/";
conceptLabV4Link.textContent = "CONCEPT LAB V4.1 ↗";
const conceptLabV4BaselineLink = document.createElement("a");
conceptLabV4BaselineLink.className = "skin-art-index-studies-link";
conceptLabV4BaselineLink.href = "/skin-art/concepts-v4-baseline/";
conceptLabV4BaselineLink.textContent = "V4 BASELINE ↗";
header.append(mark, headerMeta, visualStudiesLink, conceptMoviesLink, conceptMoviesV2Link, conceptMoviesV3Link, conceptLabV4Link, conceptLabV4BaselineLink);
