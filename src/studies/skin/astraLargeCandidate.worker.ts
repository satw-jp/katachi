...
async function export3mf(command: Extract<LargeCandidateCommand, { type: "EXPORT_3MF" }>, started: number): Promise<void> {
  ...
  const indexedSupportFaceCount = result.stats.scaffoldFaces;
