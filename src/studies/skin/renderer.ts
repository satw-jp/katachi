...
export class SkinRenderer {
   ...
   * Cyan is the existing permanent route, yellow is an added redundant route,
   * and red is a remaining single-point dependency. The actual printable
   * cylinders are already part of the permanent graph passed to
