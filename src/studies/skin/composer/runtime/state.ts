...
export const DEFAULT_COMPOSER_STATE: ComposerState = {
  ...
  camera: { mode: "DRIFT", dolly: 0.12, orbit: 0.1, targetShift: 0.16, passThrough: 0.08, fov: 46, position: [5.4, -8.2, 4.5], target: [0, 0.2, 0], up: [0, 0, 1], autoRotate: false, autoRotateSpeed: 1.2, autoRotateDirection: "CW" },
